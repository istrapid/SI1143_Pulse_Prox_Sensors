...
void readPulseSensor(){
    ...
    static int red_signalSize;
    static int red_smoothValley;
    static long red_valley;
    static long red_Peak;
    static long red_smoothRedPeak;
    static long red_smoothRedValley;
    static long red_HFoutput;
    static long red_smoothPeak; // for PSO2 calc
    static int IR_valley = 0;
    static int IR_peak = 0;
    static int IR_smoothPeak;
    static int IR_smoothValley;
    static int binOut;
    static int lastBinOut;
    static int BPM;
    static unsigned long lastTotal;
    static unsigned long lastMillis;
    static unsigned long IRtotal;
    static unsigned long valleyTime = millis();
    static unsigned long lastValleyTime = millis();
    static unsigned long peakTime = millis();
    static unsigned long lastPeakTime=millis();
    static unsigned long lastBeat;
    static unsigned long beat;
    static float IR_baseline;
    static float red_baseline;
    static float IR_HFoutput;
    static float IR_HFoutput2;
    static float shiftedOutput;
