...
#define		      BLUESWITCH		2		        // Digital pin set to switch between USB and RF serial communication
#define         BTooth        Serial      // Define the Serial variable to document the type of communication been used
#define         SPEED         115200      // Serial port speed
